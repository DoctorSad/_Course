...
with open(files_dir / "file_practice.txt", "w") as f:
...
with open(files_dir / "file_practice.txt", "r") as f:
...
with open(files_dir / "text.txt") as f:
    text = f.read()
...
with open(files_dir / "file_practice.txt", "a") as f:
    f.write(text)
